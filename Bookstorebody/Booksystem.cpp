...
#include"lubang.h"
BookSystem::BookSystem() : file_book_data("book_data"), file_isbn_index("isbn_index"), file_author_index("author_index"),
...
void BookSystem::showISBN(string isbn, vector<Book> &res) {
    book_key.clear();
    res.clear();
...
void BookSystem::showName(string name, vector<Book> &res) {
    book_key.clear();
    res.clear();
...
void BookSystem::showAuthor(string author, vector<Book> &res) {
    book_key.clear();
    res.clear();
...
void BookSystem::showKeyword(string keyword, vector<Book> &res) {
    book_key.clear();
    res.clear();
